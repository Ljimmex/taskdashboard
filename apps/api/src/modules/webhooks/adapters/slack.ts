  ...
  if (event === 'webhook.test') {
    ...
    blocks = [
      ...
      },
      {
        ...
        text: {
          type: 'mrkdwn',
          text: payload.message || 'This is a test notification from TaskDashboard.',
        },
      },
      {
        type: 'section',
    ...
    blocks = [
      ...
      },
      {
        ...
        text: {
          type: 'mrkdwn',
          text: `*<${config.appUrl}/workspaces/${job.workspaceId}/tasks/${payload.id}|${payload.title || 'Unknown Task'}>*`,
        },
      },
      {
        type: 'section',
    ...
    blocks = [
      ...
      },
      {
        ...
        text: {
          type: 'mrkdwn',
          text: `*<${config.appUrl}/workspaces/${job.workspaceId}/tasks/${payload.taskId}|${payload.title || 'Unknown Task'}>*`,
        },
      },
      {
        type: 'section',
    ...
    blocks = [
      ...
      },
      {
        ...
        text: {
          type: 'mrkdwn',
          text: `*Change:* ${payload.oldAssignees || 'Unassigned'} ➡️ ${payload.newAssignees || 'Unassigned'}`,
        },
      },
    ]
    ...
    blocks = [
      ...
      },
      {
        ...
        text: {
          type: 'mrkdwn',
          text: `*${payload.title || 'Unknown Subtask'}* in *${payload.taskTitle || 'Unknown Task'}*`,
        },
      },
    ]
    ...
    if (payload.changes?.from) {
      blocks.push({
        ...
        text: {
          type: 'mrkdwn',
          text: `*Change:* ${payload.changes.from} ➡️ ${payload.changes.to}`,
        },
      })
    } else {
      blocks.push({
    ...
    blocks = [
      ...
      },
      {
        ...
        text: {
          type: 'mrkdwn',
          text: `✅ *${payload.title || 'Unknown Subtask'}* in *${payload.taskTitle || 'Unknown Task'}* was completed.`,
        },
      },
    ]
    ...
    blocks = [
      {
        ...
        text: {
          type: 'plain_text',
          text: `${emoji} Event ${action === 'created' ? 'Created' : action === 'updated' ? 'Updated' : 'Deleted'}`,
          emoji: true,
        },
      },
      {
