...
export type WorkspaceRole =
  'owner' | 'admin' | 'project_manager' | 'hr_manager' | 'member' | 'guest'
...
export function canCreateComments(
  workspaceRole: WorkspaceRole | null,
  teamLevel: TeamLevel | null
): boolean {
...
export function canCreateLabels(
  workspaceRole: WorkspaceRole | null,
  teamLevel: TeamLevel | null
): boolean {
...
export function canUpdateLabels(
  workspaceRole: WorkspaceRole | null,
  teamLevel: TeamLevel | null
): boolean {
...
export function canDeleteLabels(
  workspaceRole: WorkspaceRole | null,
  teamLevel: TeamLevel | null
): boolean {
...
export function canCreateStages(
  workspaceRole: WorkspaceRole | null,
  teamLevel: TeamLevel | null
): boolean {
...
export function canUpdateStages(
  workspaceRole: WorkspaceRole | null,
  teamLevel: TeamLevel | null
): boolean {
...
export function canDeleteStages(
  workspaceRole: WorkspaceRole | null,
  teamLevel: TeamLevel | null
): boolean {
...
export function canReorderStages(
  workspaceRole: WorkspaceRole | null,
  teamLevel: TeamLevel | null
): boolean {
...
export function canCreateTimeEntries(
  workspaceRole: WorkspaceRole | null,
  teamLevel: TeamLevel | null
): boolean {
...
export function canManageTimeEntries(
  workspaceRole: WorkspaceRole | null,
  teamLevel: TeamLevel | null
): boolean {
...
// =============================================================================
// PERMISSION GUARDS - FILES
// =============================================================================

/** Check if user can upload files */
export function canUploadFiles(
  workspaceRole: WorkspaceRole | null,
  teamLevel: TeamLevel | null = null
): boolean {
  return hasPermission(workspaceRole, teamLevel, 'files', 'upload')
}
...
export function canViewWebhookLogs(
  workspaceRole: WorkspaceRole | null,
  teamLevel: TeamLevel | null
): boolean {
...
export function canCreateReminders(
  workspaceRole: WorkspaceRole | null,
  teamLevel: TeamLevel | null
): boolean {
