...
export const conversations = pgTable(
  'conversations',
  {
    ...
    messages: jsonb('messages').default([]).$type<
      Array<{
        id: string
        senderId: string
        content:
    ...
    participantStates: jsonb('participant_states')
      .default({})
      .$type<Record<string, { readAt?: string; deliveredAt?: string }>>(),
