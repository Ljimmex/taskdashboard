...
export function CreateFolderModal({ isOpen, onClose, parentId, onSuccess }: CreateFolderModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/40 backdrop-blur-[2px] animate-in fade-in duration-200">
            ...
            {/* Modal */}
            <div className="relative z-10 w-full max-w-md bg-[var(--app-bg-card)] border border-[var(--app-divider)] rounded-t-3xl rounded-b-none sm:rounded-2xl shadow-2xl overflow-hidden animate-in slide-in-from-bottom sm:zoom-in-95 duration-200">
                {/* Header */}
