...
export const CreationSidePanel: React.FC<CreationSidePanelProps> = ({
    ...
    return createPortal(
        <>
            ...
            {/* Panel */}
            <div className={clsx(
                "fixed top-4 right-4 bottom-4 w-full max-w-md bg-[var(--app-bg-card)] rounded-2xl z-[110] flex flex-col shadow-2xl transform transition-transform duration-300 ease-out border border-[var(--app-border)] font-sans overflow-hidden",
                ...
                <div className="p-6 border-b border-[var(--app-border)] flex items-center justify-between bg-[var(--app-bg-sidebar)]">
                    ...
                    <button onClick={onClose} className="p-2 hover:bg-[var(--app-bg-elevated)] rounded-xl text-[var(--app-text-muted)] transition-colors">
                        <X size={20} />
                    </button>
                </div>
                ...
                <form onSubmit={handleSubmit} className="flex-1 flex flex-col overflow-hidden">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="relative group">
                                <input
                                    ...
                                    autoFocus
                                    className="w-full bg-[var(--app-bg-elevated)] border border-[var(--app-border)] rounded-xl py-3 px-4 text-sm text-[var(--app-text-primary)] placeholder-[var(--app-text-muted)] focus:outline-none focus:ring-2 focus:ring-[var(--app-accent)]/50 focus:border-[var(--app-accent)] transition-all"
                                />
                    ...
                    <div className="p-6 bg-[var(--app-bg-sidebar)] border-t border-[var(--app-border)] space-y-4">
                        <button
                            type="submit"
                            className="w-full py-4 rounded-xl bg-[var(--app-accent)] text-[var(--app-accent-text)] font-bold shadow-lg shadow-amber-500/20 hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2"
                        >
                            {t('creation.submit')}
