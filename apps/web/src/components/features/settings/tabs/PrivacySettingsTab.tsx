...
export function PrivacySettingsTab() {
    ...
    const confirmEnable2FA = async () => {
        ...
        try {
            ...
            if (data?.totpURI) {
                ...
                const totpWithLogo = `${data.totpURI}&image=https://zadano.app/logo.png`
    ...
    const parseUserAgent = (uaString: string) => {
        ...
        const deviceName = device.model ? `${device.vendor || ''} ${device.model}` : (device.type === 'mobile' ? 'Mobile' : 'Desktop')
    ...
    return (
        <div className="space-y-8 max-w-4xl mx-auto">
            <div>
                ...
                <p className="text-sm text-gray-400 mt-1">Manage your security settings and privacy controls.</p>
            </div>
                ...
                <div className="bg-[#1a1a24] rounded-xl border border-gray-800/50 divide-y divide-gray-800">
                    ...
                    <div className="p-6">
                        <div className="flex items-center justify-between">
                            <h5 className="text-sm font-medium text-white">Password</h5>
                            <button
                    ...
                    {/* Phone Row */}
                    <div className="p-6 grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
                        <h5 className="text-sm font-medium text-white">Phone Number</h5>
            ...
            <section className="space-y-4">
                ...
                <div className="bg-[#1a1a24] rounded-xl p-6 border border-gray-800/50">
                    <div className="space-y-3">
                        <h5 className="text-sm font-medium text-white">2FA Security</h5>
                        ...
                        <div className="pt-3">
                            {(session?.user?.twoFactorEnabled || twoFactorSeamless) ? (
                                isDisabling2FA ? (
                                    <div className="bg-[#12121a] p-6 rounded-lg border border-red-500/20 space-y-4">
                                        <div className="flex justify-between items-start">
                                            <div>
                                                <h6 className="text-white text-sm font-medium">Disable 2FA</h6>
                                                <p className="text-xs text-gray-500">Enter your password to disable two-factor authentication.</p>
                                            </div>
                                    ...
                                    <div className="flex items-center justify-between bg-[#12121a] p-4 rounded-lg border border-gray-800">
                                        <div className="flex items-center gap-4">
                                            <div className="flex flex-col">
                                                ...
                                                <p className="text-xs text-gray-500 mt-1">Your account is secured.</p>
                                            </div>
                                        </div>
                                        <button
                                ...
                                <div className="bg-[#12121a] p-6 rounded-lg border border-gray-800 space-y-6">
                                    <div className="flex justify-between items-start">
                                        <h6 className="text-white text-sm font-medium">Setup Two-Factor Authentication</h6>
                                ...
                                <div className="bg-[#12121a] p-6 rounded-lg border border-gray-800 space-y-4">
                                    <div className="flex justify-between items-start">
                                        <div>
                                            <h6 className="text-white text-sm font-medium">Confirm Password</h6>
                                            <p className="text-xs text-gray-500">Please enter your password to enable 2FA.</p>
                                        </div>
                                ...
                                <div className="flex items-center justify-between bg-[#12121a] p-5 rounded-lg border border-gray-800">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-500">Secure your account with Google Authenticator or Authy.</p>
                                        </div>
                                    </div>
                                    <button
            ...
            <section className="space-y-4">
                ...
                <div className="bg-[#1a1a24] rounded-xl border border-gray-800/50">
                    <div className="p-6">
                        <p className="text-sm text-gray-400 mb-6">See what devices are used to log in to your account.</p>
                                            ...
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    <p className="text-sm font-medium text-white flex items-center gap-2">
                                                        {ua.desc}
                                                        {session.isCurrent ? (
                                                            <span className="text-xs text-blue-500 font-normal"> • Current device</span>
                                                        ) : (
