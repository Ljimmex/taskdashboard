                ...
                {contacts.map((contact) => (
                    ...
                    >
                        <div className="relative">
                            <div className="w-12 h-12 rounded-full bg-gradient-to-br from-amber-400 to-orange-500 flex items-center justify-center text-black font-bold ring-2 ring-transparent group-hover:ring-amber-500/50 transition-all">
                                {contact.avatar ? (
