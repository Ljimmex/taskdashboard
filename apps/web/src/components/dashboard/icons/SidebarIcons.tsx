...
export const sidebarIcons = {
    dashboard: {
        gold: (
            <svg width="20" height="20" viewBox="0 0 32 32" fill="none">
                <rect x="4" y="4" width="10" height="10" rx="3" fill="var(--app-accent-text)" />
                ...
                <rect x="18" y="18" width="10" height="10" rx="3" fill="var(--app-accent-text)" />
            </svg>
        ),
        gray: (
            <svg width="20" height="20" viewBox="0 0 32 32" fill="none">
    ...
    team: {
        gold: (
            <svg width="20" height="20" viewBox="0 0 32 32" fill="none">
                <circle cx="16" cy="10" r="4" fill="var(--app-accent-text)" />
                <path d="M8 24C8 20.134 11.134 17 15 17H17C20.866 17 24 20.134 24 24V26H8V24Z" fill="var(--app-accent-text)" />
    ...
    calendar: {
        gold: (
            <svg width="20" height="20" viewBox="0 0 32 32" fill="none">
                <path d="M6 10C6 7.79086 7.79086 6 10 6H22C24.2091 6 26 7.79086 26 10V24C26 26.2091 24.2091 28 22 28H10C7.79086 28 6 26.2091 6 24V10Z" fill="var(--app-accent-text)" />
    ...
    files: {
        gold: (
            <svg width="20" height="20" viewBox="0 0 32 32" fill="none">
                ...
                <rect x="8" y="13" width="18" height="11" rx="2" fill="var(--app-accent-text)" />
            </svg>
        ),
        gray: (
            <svg width="20" height="20" viewBox="0 0 32 32" fill="none">
    ...
    docs: {
        gold: (
            <svg width="20" height="20" viewBox="0 0 32 32" fill="none">
                <path d="M6 6C6 4.89543 6.89543 4 8 4H20L26 10V26C26 27.1046 25.1046 28 24 28H8C6.89543 28 6 27.1046 6 26V6Z" fill="var(--app-accent-text)" />
    ...
    product: {
        gold: (
            <svg width="20" height="20" viewBox="0 0 32 32" fill="none">
                ...
                <path d="M6 9L16 14L26 9L16 4L6 9Z" fill="var(--app-accent-text)" />
                <path d="M16 14V25.5" stroke="var(--app-accent-text)" strokeWidth="2" />
            </svg>
        ),
        gray: (
            <svg width="20" height="20" viewBox="0 0 32 32" fill="none">
    ...
    board: {
        gold: (
            <svg width="20" height="20" viewBox="0 0 32 32" fill="none">
                <rect x="4" y="6" width="7" height="20" rx="2" fill="var(--app-accent-text)" />
                <rect x="13" y="6" width="7" height="14" rx="2" fill="var(--app-accent-hover)" />
                <rect x="22" y="6" width="7" height="18" rx="2" fill="var(--app-accent-text)" />
            </svg>
        ),
        gray: (
            <svg width="20" height="20" viewBox="0 0 32 32" fill="none">
    ...
    logout: {
        gold: (
            <svg width="20" height="20" viewBox="0 0 32 32" fill="none">
                ...
                <path d="M16 16H28" stroke="var(--app-accent-text)" strokeWidth="3" strokeLinecap="round" />
                <path d="M22 10L28 16L22 22" stroke="var(--app-accent-text)" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
        ),
        gray: (
            <svg width="20" height="20" viewBox="0 0 32 32" fill="none">
    ...
    settings: {
        gold: (
            <svg width="20" height="20" viewBox="0 0 32 32" fill="none">
                ...
                <path d="M16 4V8M16 24V28M28 16H24M8 16H4M24.4853 7.51472L21.6569 10.3431M10.3431 21.6569L7.51472 24.4853M24.4853 24.4853L21.6569 21.6569M10.3431 10.3431L7.51472 7.51472" stroke="var(--app-accent-text)" strokeWidth="3" strokeLinecap="round" />
            </svg>
        ),
        gray: (
            <svg width="20" height="20" viewBox="0 0 32 32" fill="none">
