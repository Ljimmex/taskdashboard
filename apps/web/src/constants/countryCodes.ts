export const countryCodes = [
    ...
    { code: '+1-684', country: 'American Samoa', iso: 'AS' },
    { code: '+376', country: 'Andorra', iso: 'AD' },
    { code: '+244', country: 'Angola', iso: 'AO' },
    { code: '+1-264', country: 'Anguilla', iso: 'AI' },
    ...
    { code: '+1-441', country: 'Bermuda', iso: 'BM' },
    ...
    { code: '+1-284', country: 'British Virgin Islands', iso: 'VG' },
    ...
    { code: '+1-345', country: 'Cayman Islands', iso: 'KY' },
    ...
    { code: '+61', country: 'Cocos (Keeling) Islands', iso: 'CC' },
    ...
    { code: '+1-829', country: 'Dominican Republic', iso: 'DO' },
    { code: '+1-849', country: 'Dominican Republic', iso: 'DO' },
    ...
    { code: '+1-671', country: 'Guam', iso: 'GU' },
    { code: '+502', country: 'Guatemala', iso: 'GT' },
    { code: '+44-1481', country: 'Guernsey', iso: 'GG' },
    ...
    { code: '+389', country: 'Macedonia', iso: 'MK' },
    ...
    { code: '+1-664', country: 'Montserrat', iso: 'MS' },
    ...
    { code: '+1-670', country: 'Northern Mariana Islands', iso: 'MP' },
    ...
    { code: '+64', country: 'Pitcairn', iso: 'PN' },
    { code: '+48', country: 'Poland', iso: 'PL' },
    { code: '+351', country: 'Portugal', iso: 'PT' },
    { code: '+1-787', country: 'Puerto Rico', iso: 'PR' },
    { code: '+1-939', country: 'Puerto Rico', iso: 'PR' },
    ...
    { code: '+590', country: 'Saint Barthelemy', iso: 'BL' },
    ...
    { code: '+1-721', country: 'Sint Maarten', iso: 'SX' },
    ...
    { code: '+1-649', country: 'Turks and Caicos Islands', iso: 'TC' },
    { code: '+688', country: 'Tuvalu', iso: 'TV' },
    { code: '+1-340', country: 'U.S. Virgin Islands', iso: 'VI' },
