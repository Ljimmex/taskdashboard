            ...
            <div className="flex-1 flex flex-col bg-[var(--app-bg-page)] overflow-hidden">
                {selectedDoc ? (
                    <div className="flex-1 flex flex-col overflow-hidden p-6 max-w-5xl mx-auto w-full">
                        <div className="mb-4 rounded-2xl border border-[var(--app-border)] bg-[var(--app-bg-card)] px-4 py-3 flex items-center gap-3">
                            <div className="w-9 h-9 rounded-xl bg-[var(--app-bg-elevated)] border border-[var(--app-border)] flex items-center justify-center">
