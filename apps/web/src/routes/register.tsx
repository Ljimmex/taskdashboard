            ...
            <div className="flex w-full flex-col justify-center px-8 py-12 lg:w-1/2 lg:px-16 bg-[#0a0a0f]">
                <div className="mx-auto w-full max-w-md">
                    ...
                    <div className="mb-8 flex items-center gap-4">
                        <div className={`flex h-8 w-8 items-center justify-center rounded-full text-sm font-medium ${step >= 1 ? 'bg-amber-500 text-black' : 'bg-gray-700 text-gray-400'}`}>
                            1
                        </div>
                        <div className={`h-0.5 flex-1 ${step >= 2 ? 'bg-amber-500' : 'bg-gray-700'}`} />
                        <div className={`flex h-8 w-8 items-center justify-center rounded-full text-sm font-medium ${step >= 2 ? 'bg-amber-500 text-black' : 'bg-gray-700 text-gray-400'}`}>
                            2
                        </div>
                    </div>
                            ...
                            <div className="mt-6 flex items-center gap-4">
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <button
                                        type="button"
                                        disabled
                                        className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-800/30 cursor-not-allowed opacity-40"
                        ...
                        <form onSubmit={handleStep2} className="space-y-5">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="grid grid-cols-3 gap-3">
                                    <select
                                        ...
                                        className="bg-gray-800/50 border-0 text-white rounded-lg px-3 py-3 focus:ring-2 focus:ring-amber-500 hover:bg-gray-700/50 transition-colors appearance-none cursor-pointer"
                                        required
                                    >
                            ...
                            <div className="space-y-2">
                                ...
                                <select
                                    ...
                                    className="w-full bg-gray-800/50 border-0 text-white rounded-lg px-4 py-3 focus:ring-2 focus:ring-amber-500 hover:bg-gray-700/50 transition-colors appearance-none cursor-pointer"
                                    required
                                >
                            ...
                            {/* Phone */}
                            <div className="space-y-2">
                                <Label htmlFor="phone" className="text-gray-400 text-sm">Numer telefonu (opcjonalnie)</Label>
                                <Input
                                    id="phone"
                                    type="tel"
                                    value={phone}
                                    onChange={(e) => setPhone(e.target.value)}
                                    className="border-0 bg-gray-800/50 text-white placeholder-gray-500 rounded-lg px-4 py-3 focus:ring-2 focus:ring-amber-500 hover:bg-gray-700/50 transition-colors"
                            ...
                            <div className="flex gap-4">
                                <Button
                                    ...
                                    onClick={() => setStep(1)}
                                    variant="outline"
                                    className="flex-1 py-6 rounded-full border-gray-700 text-gray-300 hover:bg-gray-800"
                                >
                                    ← Wstecz
                                </Button>
                                <Button
