  ...
  const handleInviteJoin = async (inviteId: string) => {
    ...
    try {
      ...
      if (signInResult.error) {
        if (
          (signInResult.error as any).code === 'EMAIL_NOT_VERIFIED' ||
          signInResult.error.message === 'Email not verified'
        ) {
      ...
      const targetSlug =
        acceptResponse.workspaceSlug || acceptResponse.data?.workspaceSlug || 'dashboard'
  ...
  const handleStep3 = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (selectedPlanParam && ['plus', 'pro'].includes(selectedPlanParam)) {
        ...
        const checkoutRes = await apiFetchJson<{ data: { url: string; checkoutId: string } }>(
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="w-full rounded-none border-0 border-b-2 border-gray-700 bg-transparent pb-3 text-center text-xl tracking-widest text-white placeholder-gray-500 shadow-none outline-none transition-colors focus:border-amber-500 focus:ring-0 focus-visible:ring-0 focus-visible:ring-offset-0"
            ...
            <>
              {success ? (
                <div className="rounded-lg border border-green-500/20 bg-green-500/10 p-6 text-center">
                  ...
                  <p className="mb-6 text-gray-400">{t('register.success.message', { email })}</p>
                  <Link
                    to="/login"
                    className="inline-block w-full rounded-full bg-amber-500 px-4 py-3 font-medium text-black transition-colors hover:bg-amber-400"
                  >
                ...
                <>
                  ...
                  <div className="mb-8 flex items-center gap-4">
                    {/* Step 1 */}
                    <div
                      className={`flex h-8 w-8 items-center justify-center rounded-full text-sm font-medium ${step >= 1 ? 'bg-amber-500 text-black' : 'bg-gray-700 text-gray-400'}`}
                    >
                      1
                    </div>
                    ...
                    {/* Step 2 */}
                    <div
                      className={`flex h-8 w-8 items-center justify-center rounded-full text-sm font-medium ${step >= 2 ? 'bg-amber-500 text-black' : 'bg-gray-700 text-gray-400'}`}
                    >
                      2
                    </div>
                    ...
                    {/* Step 3 */}
                    <div
                      className={`flex h-8 w-8 items-center justify-center rounded-full text-sm font-medium ${step >= 3 ? 'bg-amber-500 text-black' : 'bg-gray-700 text-gray-400'}`}
                    >
                      3
                    </div>
                  </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative">
                          ...
                          <button
                            ...
                            className="absolute right-0 top-1/2 -translate-y-1/2 text-gray-500 transition-colors hover:text-white"
                          >
                            {showPassword ? (
                              <svg
                                className="h-5 w-5"
                      ...
                      <div className="mt-6 flex items-center gap-4">
                        ...
                        <div className="flex gap-2">
                          ...
                          <button
                            ...
                            className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-800/50 transition-colors hover:bg-gray-700"
                            title="GitHub"
                          >
                            <svg
                  ...
                  {step === 2 && (
                    <form onSubmit={handleStep2} className="space-y-5">
                      ...
                      {/* Date of Birth */}
                      <div className="space-y-2">
                        <Label className="text-sm text-gray-400">{t('register.birthDate')}</Label>
                        <div className="grid grid-cols-3 gap-3">
                          <Select value={birthDay} onValueChange={setBirthDay}>
                            <SelectTrigger className="h-auto rounded-none border-0 border-b-2 border-gray-700 bg-transparent px-0 py-3 text-white focus:border-amber-500 focus:ring-0 focus:ring-offset-0">
                              <SelectValue placeholder={t('register.day')} />
                            </SelectTrigger>
                            <SelectContent className="border-gray-800 bg-[#12121a] text-white">
                              {Array.from({ length: 31 }, (_, i) => (
                                <SelectItem
                                  className="cursor-pointer text-white focus:bg-gray-800 focus:text-white"
                                  key={i + 1}
                                  value={String(i + 1)}
                                >
                                  {i + 1}
                      ...
                      <div className="space-y-2">
                        ...
                        <Select value={gender} onValueChange={setGender}>
                          <SelectTrigger className="h-auto w-full rounded-none border-0 border-b-2 border-gray-700 bg-transparent px-0 py-3 text-white focus:border-amber-500 focus:ring-0 focus:ring-offset-0">
                          ...
                          <SelectContent className="border-gray-800 bg-[#12121a] text-white">
                            ...
                            <SelectItem
                              ...
                              value="other"
                            >
                              {t('register.genderOptions.other')}
                            </SelectItem>
                            <SelectItem
                              className="cursor-pointer text-white focus:bg-gray-800 focus:text-white"
                              value="prefer_not_to_say"
                            >
                              {t('register.genderOptions.prefer_not_to_say')}
                            </SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
                      ...
                      <div className="flex gap-4">
                        <Button
                          ...
                          onClick={() => setStep(1)}
                          variant="ghost"
                          className="flex-1 rounded-full bg-gray-800 py-6 text-white hover:bg-gray-700 hover:text-gray-200"
                        >
                          {t('register.back')}
                        </Button>
                        <Button
                          type="submit"
                          className="flex-1 rounded-full bg-amber-500 py-6 font-medium text-black hover:bg-amber-400"
                        >
                          {t('register.next')}
                        </Button>
                      </div>
                    ...
                    <form onSubmit={handleStep3} className="space-y-5">
                      <div className="mb-6 text-center">
                        ...
                        <p className="text-sm text-gray-400">
                          Stwórz przestrzeń dla swojego zespołu
                        </p>
                      </div>

                      <div className="space-y-2">
                        <Label htmlFor="workspaceName" className="text-sm text-gray-400">
                        ...
                        <Select value={teamSize} onValueChange={setTeamSize}>
                          ...
                          <SelectContent className="border-gray-800 bg-[#12121a] text-white">
                            <SelectItem
                              ...
                              value="1-10"
                            >
                              {t('register.teamSizeOptions.1-10')}
                            </SelectItem>
                            <SelectItem
                              className="cursor-pointer text-white focus:bg-gray-800 focus:text-white"
                              value="11-50"
                            >
                              {t('register.teamSizeOptions.11-50')}
                            </SelectItem>
                            <SelectItem
                              className="cursor-pointer text-white focus:bg-gray-800 focus:text-white"
                              value="51-200"
                            >
                              {t('register.teamSizeOptions.51-200')}
                            </SelectItem>
                            <SelectItem
                              className="cursor-pointer text-white focus:bg-gray-800 focus:text-white"
                              value="200+"
                            >
                              {t('register.teamSizeOptions.200+')}
                            </SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
                        ...
                        <Select value={industry} onValueChange={setIndustry}>
                          ...
                          <SelectContent className="border-gray-800 bg-[#12121a] text-white">
                            <SelectItem
                              ...
                              value="Technology"
                            >
                              {t('register.industryOptions.Technology')}
                            </SelectItem>
                            <SelectItem
                              className="cursor-pointer text-white focus:bg-gray-800 focus:text-white"
                              value="Gamedev"
                            >
                              {t('register.industryOptions.Gamedev')}
                            </SelectItem>
                            <SelectItem
                              className="cursor-pointer text-white focus:bg-gray-800 focus:text-white"
                              value="Marketing"
                            >
                              {t('register.industryOptions.Marketing')}
                            </SelectItem>
                            <SelectItem
                              className="cursor-pointer text-white focus:bg-gray-800 focus:text-white"
                              value="Finance"
                            >
                              {t('register.industryOptions.Finance')}
                            </SelectItem>
                            <SelectItem
                              className="cursor-pointer text-white focus:bg-gray-800 focus:text-white"
                              value="Education"
                            >
                              {t('register.industryOptions.Education')}
                            </SelectItem>
                            <SelectItem
                              className="cursor-pointer text-white focus:bg-gray-800 focus:text-white"
                              value="Health"
                            >
                              {t('register.industryOptions.Health')}
                            </SelectItem>
                            <SelectItem
                              className="cursor-pointer text-white focus:bg-gray-800 focus:text-white"
                              value="E-commerce"
                            >
                              {t('register.industryOptions.E-commerce')}
                            </SelectItem>
                            <SelectItem
                              className="cursor-pointer text-white focus:bg-gray-800 focus:text-white"
                              value="Other"
                            >
                              {t('register.industryOptions.Other')}
                            </SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
      ...
      <div className="hidden flex-col justify-center bg-[#0d0d12] px-16 lg:flex lg:w-1/2">
        <div className="max-w-lg">
          <h2 className="text-5xl font-bold leading-tight text-white">
            ...
            <span className="text-amber-500">{t('auth.marketingTitleStrong')}</span>
            <br />
            {t('auth.marketingTitle2')}
          </h2>
          <p className="mt-6 text-lg text-gray-400">{t('auth.marketingDesc')}</p>
